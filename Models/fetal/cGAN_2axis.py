...
class CGAN():
    def __init__(self):
        ...
        img = self.generator([noise, x2, x3])
        ...
        valid = self.discriminator([img, x2, x3])

        # The combined model  (stacked generator and discriminator)
        # Trains generator to fool discriminator
        self.combined = Model([noise, x2, x3], valid)
    ...
    def build_discriminator(self):
        ...
        model_input = concatenate([tower_2, tower_3], axis=-1)
...
##################### Training Procedure #######################################
    ...
    def sample_images(self, epoch, x, x1, x2, x3, affine, fold, save_path):
        ...
        gen_imgs = self.generator.predict([noise, x2_c,x3_c])
        gen_imgs = np.reshape(gen_imgs, (96,96,96))
...
if __name__ == '__main__':
    ...
    fileLocations = {
                ...
                "sample_path" : './niftiImage/2axis/Test/',
                "predict_path" : './niftiImage/2axis/Sample/',
                "models" : './cGAN_model/2axis/',
                "logs" : './logs/2axis/',
            }
